  ...
  return (
    <div className="game-card-reveal fixed inset-0 z-50 grid place-items-center bg-[rgba(4,12,15,0.48)] p-2 backdrop-blur-sm sm:p-4">
      <section
        ...
        className="game-card-reveal__card relative grid w-full max-w-sm gap-4 rounded-xl border border-[var(--line)] bg-[var(--bg-base)] p-4 text-center shadow-[0_30px_100px_rgba(4,12,15,0.38)] sm:gap-5 sm:rounded-2xl sm:p-6"
      >
        <button
          type="button"
        ...
        <div className="mx-auto grid h-16 w-14 place-items-center rounded-lg border border-[var(--line)] bg-[color-mix(in_oklab,var(--primary)_18%,var(--surface))] shadow-[0_18px_42px_rgba(4,12,15,0.2)] sm:h-24 sm:w-20 sm:rounded-2xl">
