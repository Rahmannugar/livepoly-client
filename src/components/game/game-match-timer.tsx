...
export function GameMatchTimer({
  ...
  return (
    <div className="mx-auto flex w-fit min-w-36 self-center justify-self-center rounded-full border border-[var(--line)] bg-[var(--surface)] px-5 py-2 text-center shadow-[0_18px_45px_rgba(4,12,15,0.14)]">
